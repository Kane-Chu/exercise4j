package kane.exercise.springaop.jdkcglibtest;

import java.util.LinkedHashMap;
import java.util.Map;

import kane.exercise.springaop.jdkcglibtest.proxy.CglibProxyTest;
import kane.exercise.springaop.jdkcglibtest.proxy.JdkDynamicProxyTest;
import kane.exercise.springaop.jdkcglibtest.targets.Target;
import kane.exercise.springaop.jdkcglibtest.targets.TargetImpl;
...
public class ProxyPerformanceTest {
    public static void main(String[] args) {
        ...
        int repeatCount = 3;
        int runCount = 1_000_000;
        runTest(repeatCount, runCount, tests);
        runCount = 50_000_000;
        runTest(repeatCount, runCount, tests);
        runCount = 100_000_000;
        runTest(repeatCount, runCount, tests);
    }
